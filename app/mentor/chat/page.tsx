...
function MentorChatContent() {
  ...
  const handleSelectConversation = (id: string, otherUser: any) => {
    ...
    router.push(`/mentor/chat?conversationId=${id}`, { scroll: false });
  };
  ...
  return (
    <div className="flex h-[calc(100vh-var(--header-height,5rem))] w-full bg-background overflow-hidden relative -m-4 md:-m-6">
      <ChatSidebar
