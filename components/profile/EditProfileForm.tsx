          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-2 text-muted-foreground/80">
              ...
              <Input
                ...
                value={profile.Email || ""}
                disabled
                className="bg-muted/50 border-transparent h-11 cursor-not-allowed italic"
              />
            </div>
            ...
            <div className="space-y-2 text-muted-foreground/80">
              ...
              <Input
                ...
                value={profile.Role || ""}
                disabled
                className="bg-muted/50 border-transparent h-11 cursor-not-allowed italic capitalize"
              />
            </div>
